...
#SBATCH --output=/work/gene8940/fae75933/log.%j			    # Standard output and error log - # replace cbergman with your myid
#SBATCH --mail-user=fae75933@uga.edu                    # Where to send mail - # replace cbergman with your myid
#SBATCH --mail-type=END,FAIL                            # Mail events (BEGIN, END, FAIL, ALL)

#set input and output directory variables
OUTDIR="/work/gene8940/fae75933/"                       # replace cbergman in the following line with your myid
