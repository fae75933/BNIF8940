...
bwa mem -M -v 3 -t $THREADS -v 0 /scratch/fae75933/genomesfolder/GCA_000182925_neurospora $f | samtools view -bhu - | samtools sort -@ $THREADS -T $file -o "$sorted.bam" -O bam -
